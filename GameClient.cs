...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
            ...
            if(score[turaPlayer] >=0 && score[turaPlayer] <70)
            {
                ...
                switch (value)
                {
                    case 0:
                        ...
                        label1.Text ="Rezultatul "+ Convert.ToString(q) + "+" + Convert.ToString(z)+" este:";
                    ...
                    case 1:
                        ...
                        else
                        {
                            ...
                            label1.Text ="Rezultatul "+ Convert.ToString(z) + "-" + Convert.ToString(q)+" este:";
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if(score[0]==Convert.ToInt32(maxHighscore))
            {
                ...
                if(score[1] == Convert.ToInt32(maxHighscore))
                {
                    pictureBox13.Visible = false;
                    pictureBox9.Visible = false;
                ...
                if(score[2] == Convert.ToInt32(maxHighscore))
                {
                pictureBox13.Visible = false;
        ...
        const string SERVER_IP = "79.119.22.192";
